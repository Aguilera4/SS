...
//		delete  y_aux;
	...
	//	cout << " y(0) "<< __y[0] << endl;
		...
		cerr << " Perido de pesca => ";
		cin >> perido_pesca;

		periodo = perido_pesca;

		cerr << " Reducción de peces grandes en cada campana => ";
		cin >> reduccion_pesca;

		reducion = reduccion_pesca;
